const translations = {
  fr: {
    ...
    parcours: {
      title: "Mon parcours",
      subtitle: "Trois étapes, une logique : comprendre, créer, connecter",
      citation: "Coder, c'est apprendre un nouveau langage — et ça, c'est mon terrain.",
      etapes: [
        { titre: "Linguiste", sous: "LEA Anglais / Espagnol" },
        { titre: "Commerciale", sous: "10 ans — Relation client" },
        { titre: "Développeuse", sous: "Fullstack — 2025/2026" },
      ],
    },
    projets: {
      title: "Mes projets",
  ...
  en: {
    ...
    parcours: {
      title: "My journey",
      subtitle: "Three steps, one logic: understand, create, connect",
      citation: "Coding is learning a new language — and that's my territory.",
      etapes: [
        { titre: "Linguist", sous: "BA English / Spanish" },
        { titre: "Sales Manager", sous: "10 years — Client relations" },
        { titre: "Developer", sous: "Fullstack — 2025/2026" },
      ],
    },
    projets: {
      title: "My projects",
      voirGithub: "View on GitHub",
      voirSite: "View site →",
      fonctionnalites: "Features",
      role: "My role",
      difficultes: "Challenges",
    },
    contact: {
  ...
  es: {
    ...
    hero: {
      ...
      btnEmail: "Enviarme un correo",
    },
    parcours: {
      title: "Mi trayectoria",
      subtitle: "Tres etapas, una lógica: comprender, crear, conectar",
      citation: "Programar es aprender un nuevo idioma — y ese es mi terreno.",
      etapes: [
        { titre: "Lingüista", sous: "Inglés / Español" },
        { titre: "Comercial", sous: "10 años — Atención al cliente" },
        { titre: "Desarrolladora", sous: "Fullstack — 2025/2026" },
      ],
    },
    projets: {
      title: "Mis proyectos",
      voirGithub: "Ver en GitHub",
      voirSite: "Ver sitio →",
      fonctionnalites: "Funcionalidades",
      role: "Mi rol",
      difficultes: "Dificultades",
    },
    contact: {
