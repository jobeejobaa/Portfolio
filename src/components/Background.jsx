function Background() {
  return (
    <div className="bg-decoration" aria-hidden="true">
      ...
      >
        <defs>
          {/* Dégradé de base : du corail pastel (haut-droit) au turquoise pastel (bas-gauche) */}
          <linearGradient id="grad-base" x1="100%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#FFB5A8" />
            <stop offset="45%" stopColor="#FFD4C2" />
            <stop offset="55%" stopColor="#C8E8E2" />
            <stop offset="100%" stopColor="#9FDDD6" />
          </linearGradient>

          {/* Vagues corail pastel */}
          <linearGradient id="grad-corail" x1="100%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#FF9685" />
            <stop offset="100%" stopColor="#FFB89C" />
          </linearGradient>

          {/* Vagues turquoise pastel */}
          <linearGradient id="grad-turquoise" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#7DD3CB" />
            <stop offset="100%" stopColor="#A8E0DC" />
          </linearGradient>
        </defs>

        {/* Fond plein : transition douce corail → turquoise (pas de bande beige) */}
        <rect width="1440" height="900" fill="url(#grad-base)" />

        {/* Vagues corail décoratives (haut-droit) */}
        <path
          d="M1440,0 L1440,360 C1180,330 980,440 720,370 C460,305 220,370 0,310 L0,0 Z"
          fill="url(#grad-corail)"
          opacity="0.55"
        />
        <path
